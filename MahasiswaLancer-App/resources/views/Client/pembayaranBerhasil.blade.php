    ...
    <div class="col-12 grid-margin" style="padding-top:40px;">
        ...
        <div class="card" style="border-radius: 37px; width:947px; box-shadow: 0px 9px 10px rgba(0, 0, 0, 0.1); left:150px">
            <div class="card-body">
                ...
                <p class="text-center fw-bold" style="margin-top: -10px">12308923</p>
                <p class="text-center">Nama</p>
                <p class="text-center fw-bold" style="margin-top: -10px">{{ Auth::user()->name }}</p>
                <p class="text-center">Email</p>
                <p class="text-center fw-bold" style="margin-top: -10px">{{ Auth::user()->email }}</p>
                <div class="mb-4">
                    ...
                    <button type="submit" class="btn"
                            style="width: 255px; height: 48px; 
                                    ...
                                    margin-left:32px;"><b>Cari Jasa Lain</b></button>
                </div>   
            </div>
        </div>
