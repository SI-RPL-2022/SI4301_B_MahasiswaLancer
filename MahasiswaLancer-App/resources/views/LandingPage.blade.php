...
<body>
        ...
        <div class="row" style="background-color: #DAE3DC;">
            ...
            <ul class="nav" style="margin-left: 330px; margin-top: 30px;">
                ...
                <li class="nav-item" style="padding-right: 30px;">
                   <a class="nav-link text-black" href="#"><b>Masuk</b></a>
                 </li>
                 <li class="nav-item" style="padding-right: 40px; padding-top: 5px;">
                   <button href="" class="btn-sm text-light" style="background-color: #151E17; border-radius: 86px; width: 85px;"><b>Daftar</b></button>
                 </li>
             </ul>
            ...
            <div class="container m-l-150">
                <div class="row">
                    <div class="col-5" style="padding-top: 200px;">
                        ...
                        <br>
                        <a style="color: #626E65;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra varius donec sed nec. </a>
                    </div>
            ...
            <div class="container p-t-80">
                ...
                <div class="card-group p-t-60" >
                    <div class="card" style="border-color: #F3F9F3;">
                      <img src="asset-images/search.png" class="card-img-top p-t-50 m-l-40" alt="..." style="width: 50px;">
                      <div class="card-body m-l-25">
                        <h6 class="card-title"><b>Pilih Jasa yang Sesuai</b></h6>
                        <p class="card-text">Lorem ipsum dolor sit amet, consecter adipising elit. Elit urna tellus feugiat lacus sit.</p>
                        <br>
                        <a href=""><u><b>Learn More</b></u></a>
                      </div>
                    </div>
    
                    <div class="card" style="border-color: #F3F9F3; background-color: rgba(255, 255, 255, 0.6);">
                      <img src="asset-images/two-users.png" class="card-img-top p-t-50 m-l-40" alt="..." style="width: 50px;">
                      <div class="card-body m-l-25">
                        <h6 class="card-title"><b>Pilih Jasa yang Sesuai</b></h6>
                        <p class="card-text">Lorem ipsum dolor sit amet, consecter adipising elit. Elit urna tellus feugiat lacus sit.</p>
                        <br>
                    ...
                    <div class="card" style="border-color: #F3F9F3; background-color: rgba(255, 255, 255, 0.4)">
                        <img src="asset-images/wallet.png" class="card-img-top p-t-50 m-l-40" alt="..." style="width: 50px;">
                        <div class="card-body m-l-25">
                          <h6 class="card-title"><b>Pilih Jasa yang Sesuai</b></h6>
                          <p class="card-text">Lorem ipsum dolor sit amet, consecter adipising elit. Elit urna tellus feugiat lacus sit.</p>
                          <br>
                    ...
                    <div class="card" style="border-color: #F3F9F3; background-color: rgba(255, 255, 255, 0.1)">
                        <img src="asset-images/flag.png" class="card-img-top p-t-50 m-l-40" alt="..." style="width: 50px;">
                        <div class="card-body m-l-25">
                          <h6 class="card-title"><b>Pilih Jasa yang Sesuai</b></h6>
                          <p class="card-text">Lorem ipsum dolor sit amet, consecter adipising elit. Elit urna tellus feugiat lacus sit.</p>
                          <br>
        ...
        <div class="row" style="background: #121814; height: 1700px;">
            <div class="container p-t-80">
                ...
                <div class="row p-l-40 p-t-50">
                    ...
                    <span class="badge badge-pill" style="background-color: grey; margin-left: 50px;">Ilmu Komputer</span>
                ...
                <div class="row p-l-80 p-t-20">
                    ...
                    <span class="badge badge-pill" style="background-color: grey; margin-left: 50px;">Pengembangan Diri</span>
                    <span class="badge badge-pill" style="background-color: grey; margin-left: 50px;">Leadership</span>
                    <span class="badge badge-pill" style="background-color: grey; margin-left: 50px;">Digital</span>
                    <span class="badge badge-pill" style="background-color: grey; margin-left: 50px;">Geografi Bumi</span>
                </div>
                ...
                <div class="row" style="width: 1200px;">
                    ...
                    <!-- Card 1 -->
                    <div class="card" style="width: 17rem; margin-top: 40px; border-radius: 30px; margin-left:15px; padding: 0; height: 320px; background-color: #202922;">
    ...
    <section class="row" style="background-color: #121814;">
        <div class="container text-center">
            <br>
            <img src="asset-images/LOGO MAHASWISA LANCER white.png" alt="Avatar Logo" style="width:250px; margin-top: 50px;">
    ...
    <div class="row" style="background-color: #000000;">
        <div class="container">
            <p class="text-center text-white p-t-20" style="height: 60px;">© 2022 MahasiswaLancer. All Rights Reserved</p>
        </div> 
    </div>
